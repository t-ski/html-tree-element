...
(() => {
    ...
    class HTMLTreeElement extends HTMLElement {
        ...
        #build() {
            if(!this.#data) throw new ReferenceError("Data is undefined");
            if(!this.#template) throw new ReferenceError("Template is undefined");
            ...
            const createWrapperElement = (node) => {
                ...
                delete nodeData.ratio;
                delete nodeData[this.#configuration.childrenPropertyIdentifier];
                this.#nodeCallback(nodeData, nodeInnerShadowRoot, isLeafNode);
            ...
            this.#transformChild = createWrapperElement(calcSpaceRatio(this.#data));
        ...
        data(treeObject) {
            ...
            this.#template && setTimeout(() => this.#build(), 0);
        ...
        template(templateElementOrSelector) {
            ...
            this.#data && setTimeout(() => this.#build(), 0);
